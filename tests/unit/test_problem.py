...
from learncentive.src.problem import ProblemGenerator, Problem
...
# Due to floating point arithmetic, it's sufficient to check answer within a hundreth
    test_problem = ProblemGenerator.generate('division')
